...
|------------------|-------------------|
|Distance between box attached to the bike frame and the spoke | The measured minimum distance between the bike spoke and frame was found to be 30 mm meaning that the device canwill be no larger than 20 mm in depth protruding from the frame in between the spoke and the frame. |
...
|Diameter of the Wheel | The device must support the minimum wheel size of 45.72 cm in diameter to account for the smallest potential bike to be riding a trail. |
...
|Splash Resistant | The kit shall have the ability to be fully submerged in waterthe ability to withstand splashes from puddles and rain|
...
![Work system housing from front view](https://github.com/Baebel43/team5capstone/blob/main/Documentation/Images/WorkSystemBoxV2_front.png)

Figure 4. Design of Housing for work system front view with measurements

![Work system housing from top view](https://github.com/Baebel43/team5capstone/blob/main/Documentation/Images/WorkSystemBoxV2_Top.png)

Figure 5. Design of Housing for work system top view with measurements

![Work system housing lid](https://github.com/Baebel43/team5capstone/blob/main/Documentation/Images/WorkSystemLidv2.png)

Figure 6. Design of Housing lid with measurements
...
Figure 7. Design of magnet holder within spoke
...
Figure 8. Back design of magnet holder within spoke
